...
public class RobotMap {
    public static class DriveTrainMap {
        ...
        public static final double ksVolts = 0.01994; //0.6384
        public static final double kvVoltSecondsPerMeter = 0.54714; //0.023005
        public static final double kaVoltSecondsSquaredPerMeter = 0.01399; //0.0014474

        // Example value only - as above, this must be tuned for your drive!
        public static final double kPDriveVel = 0.1059;  //0.061451
        ...
        public static double metersPerPulse = 0.00306295662328076126168625148735;
